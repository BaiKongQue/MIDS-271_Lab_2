...
```{r full keeling curve plot, echo=FALSE}
...
first_420_mean <- min(co2_forecast$index[co2_model$.mean >= 420])
...
first_500_mean <- min(co2_forecast$index[co2_model$.mean >= 500])
```

```{r threshold estimates}
print("First 420 lower bound")
print(last_420_lower$index[1])
print("First 420 upper bound")
print(first_420_upper$index[1])
print("First 420 point estimate")
print(first_420_mean)

print("First 500 lower bound")
print(last_500_lower$index[1])
print("First 500 upper bound")
print(first_500_upper$index[1])
print("First 500 point estimate")
print(first_500_mean)
```
...
sa_train_accuracy <- sa_forecast %>% accuracy(co2_present_ts)
```
...
nsa_accuracy <- nsa_forecast %>% accuracy(co2_present_ts)
```

```{r sa polynomial}
co2_sa_poly <- lm(average ~ poly(time_index, degree = 2, raw = TRUE), data = test_data)
```
